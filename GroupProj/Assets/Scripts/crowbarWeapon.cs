...
public class crowbarWeapon : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        animator.SetTrigger("useCBar");
        //isReloading = false;
        animator.ResetTrigger("CBarAttack");
    ...
    void Update()
    {
        ...
        //    return;
        //}
        if (Input.GetButtonDown("Shoot") && !isShooting)//Time.time >= nextTimeToFire)
        {
    ...
    IEnumerator shoot()
    {
        animator.SetTrigger("CBarAttack");
        isShooting = true;
